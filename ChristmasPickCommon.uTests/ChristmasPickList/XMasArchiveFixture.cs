...
namespace ChristmasPickCommon.uTests.ChristmasPickList
{
  public class XMasArchiveFixture : BaseFixture
  {
    ...
    public void TestChristmasArchiveSerialization()
    {
      ...
      Assert.Equal($"<?xml version=\"1.0\" encoding=\"utf-8\"?>{Environment.NewLine}<XMasArchive>{Environment.NewLine}  <ChristmasPast>{Environment.NewLine}    <XMasDate>12/25/1971</XMasDate>{Environment.NewLine}    <Picks>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Ann\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"05111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Clare\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"51111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Clare\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"15111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Beth\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"52111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Beth\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"25111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Meg\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"53111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Meg\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"35111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Ann\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"50111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}    </Picks>{Environment.NewLine}  </ChristmasPast>{Environment.NewLine}  <ChristmasPast>{Environment.NewLine}    <XMasDate>12/25/1972</XMasDate>{Environment.NewLine}    <Picks>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Clare\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"05111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Ann\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"51111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Ann\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"15111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Beth\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"52111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Beth\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"25111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Meg\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"53111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Meg\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"35111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Clare\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"50111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}    </Picks>{Environment.NewLine}  </ChristmasPast>{Environment.NewLine}  <ChristmasPast>{Environment.NewLine}    <XMasDate>12/25/1973</XMasDate>{Environment.NewLine}    <Picks>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Clare\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"05111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Beth\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"51111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Beth\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"15111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Ann\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"52111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Ann\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"25111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Meg\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"53111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Meg\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"35111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Clare\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"50111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}    </Picks>{Environment.NewLine}  </ChristmasPast>{Environment.NewLine}  <ChristmasPast>{Environment.NewLine}    <XMasDate>12/25/1974</XMasDate>{Environment.NewLine}    <Picks>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Clare\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"05111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Beth\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"51111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Beth\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"15111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Meg\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"52111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Meg\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"25111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Ann\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"53111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}      <Pick>{Environment.NewLine}        <Subject firstname=\"Ann\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"35111111-2222-3333-4444-555555555555\" />{Environment.NewLine}        <Recipient firstname=\"Clare\" lastname=\"Gehred\" birthday=\"7/27/1972\" id=\"50111111-2222-3333-4444-555555555555\" />{Environment.NewLine}      </Pick>{Environment.NewLine}    </Picks>{Environment.NewLine}  </ChristmasPast>{Environment.NewLine}</XMasArchive>", actual);
